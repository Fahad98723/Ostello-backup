const siteUrl = "https://www.ostello.co.in/";
module.exports = {
  siteUrl,
  ...
  exclude: [
    ...
    "/admin-dashboard/careers/add",
    "/admin-dashboard/careers/edit",
    ...
    "/merchant-landing",
    "/merchant/dashboard",
    "/merchant/dashboard/accountancy",
    "/merchant/dashboard/addCourses",
    "/merchant/dashboard/courses",
    "/merchant/dashboard/notifications",
    "/merchant/dashboard/profile",
    "/merchant/dashboard/settings",
    "/merchant/dashboard/students",
    "/merchant/details",
    "/merchant/details/success",
    "/merchant/login/forgot",
    "/profile/manageCards",
    ...
    "/profile/wishlist",
    "/terms",
    "/merchant/dashboard/posts",
    "/merchant/dashboard/posts",
    "/merchant/dashboard/posts/add",
    "/merchant/dashboard/posts/edit",
    "/coaching-in-99",
