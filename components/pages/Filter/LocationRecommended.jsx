...
const LocationRecommended = ({ name, content }) => {
  ...
  const filterByCategory = async (cat) => {
    try {
      ...
      const { data } = await axios.get(
        `${host}/institute?approval=1&services=${query}&location=${
          locationBy || locationQuery
        }&limit=50`
      );
      ...
      <div className=" md:flex grid grid-cols-2 gap-2  items-center my-5">
        <div className="relative  my-1">
          <p
            ...
            className="flex w-full justify-between md:w-36 items-center  cursor-pointer border-4 border-solid border-primary    p-2"
          >
        ...
        <div className="relative">
          <p
            ...
            className="flex w-full justify-between items-center md:w-36 cursor-pointer border-2 border-solid border-light-gray   p-2"
          >
            <p className={` text-[#000000] text-[13px] `}>
